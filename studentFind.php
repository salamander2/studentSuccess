...
if ($activate) {
	...
	$query = "SELECT students.studentID, students.firstname, students.lastname, sssInfo.grade, sssInfo.selected, sssInfo.lastMtg FROM students INNER JOIN sssDB.sssInfo ON students.studentID=sssDB.sssInfo.studentID ORDER BY lastname, firstname";
