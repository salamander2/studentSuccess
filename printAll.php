...
$sql="SELECT schoolDB.students.studentID, CONCAT_WS(', ', schoolDB.students.lastname, schoolDB.students.firstname) AS studentName, tcontact.teacher, tcontact.contactMethod, tcontact.personContacted, tcontact.date, tcontact.notes FROM schoolDB.students LEFT JOIN tcontact ON tcontact.studentID=schoolDB.students.studentID ORDER BY schoolDB.students.lastname, schoolDB.students.firstname, tcontact.teacher, tcontact.timestamp;";
// sending query
